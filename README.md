...
2. Linux Scale Set should use minimum 1 instance ; Linux Scale Set will create its own Traffic Manager that is accessible from the internet
3. First virtual machine -> allow inbound traffic from internet only.
4. Create Azure MySQL to use with wordpress autoscaling group.
